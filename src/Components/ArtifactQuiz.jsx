    ...
    <div className="space-y-4">
      ...
      <div className="bg-white shadow-md rounded-lg">
        <details className="group p-4">
          <summary className="flex justify-between items-center cursor-pointer text-lg font-medium text-blue-500">
          What is the most ancient artifact in the collection?
            <span className="ml-2 text-blue-500 group-open:rotate-180 transform transition-transform duration-300"><HiOutlineChevronDoubleRight /></span>
          </summary>
      ...
      <div className="bg-white shadow-md rounded-lg">
        <details className="group p-4">
          ...
          How are artifacts authenticated before display?
            <span class="ml-2 text-blue-500 group-open:rotate-180 transform transition-transform duration-300"><HiOutlineChevronDoubleRight /></span>
          </summary>
          <p className="mt-2 text-gray-600">
