  ...
  return (
    <div className="carousel w-full h-[500px] rounded-xl mt-5 ">
      <div id="slide1" className="carousel-item relative w-full">
        <div
          style={{
            background: `url("https://i.ibb.co.com/BNhw7vb/pexels-miraybostanci-3234893.jpg")`,
      ...
      <div id="slide2" className="carousel-item relative w-full">
        <div
          style={{
            background: `url("https://i.ibb.co.com/HCn7PgX/pexels-gonzalo-mendiola-95842233-24706485.jpg")`,
            backgroundPosition: "center",
            backgroundRepeat: "no-repeat",
            backgroundSize: "cover",
          }}
      ...
      <div id="slide3" className="carousel-item relative w-full">
        <div
          style={{
            background: `url("https://i.ibb.co.com/VBDnPw6/pexels-iamngakaneka-889973.jpg")`,
            backgroundPosition: "center",
            backgroundRepeat: "no-repeat",
            backgroundSize: "cover",
          }}
      ...
      <div id="slide4" className="carousel-item relative w-full">
        <div
          style={{
            background: `url("https://i.ibb.co.com/zHG4Mbx/pexels-martinpechy-2844471-1.jpg")`,
            backgroundPosition: "center",
            backgroundRepeat: "no-repeat",
            backgroundSize: "cover",
          }}
