          ...
          <label className="label text-xl">
            <a href="#" className="label-text-alt link link-hover text-blue-500">Forgot password?</a>
              ...
              <button
                ...
                className=" btn w-full bg-gradient-to-r from-blue-500 to-black text-white py-3 rounded-lg text-lg font-semibold hover:opacity-90 transition duration-300"
              >
                Login
              </button>
              </div>
...
<p className="text-center text-sm  mt-4">
           ...
           <Link to="/register"> <span className="text-blue-500 hover:underline">
              Register Now
            </span></Link>
          </p>
          </div>
